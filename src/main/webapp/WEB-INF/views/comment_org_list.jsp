	...
	<div class="content-body">
		...
		<div id="${ModelKey}sTableEidtDlgButtons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok"
				onclick="commentOrgAct.save()" style="width: 90px">保存</a> <a
					...
					$('#${ModelKey}EidtFm').form('submit', {
						...
						success : function(result) {
							...
							if (!result.success) {
								...
								$("#${ModelKey}sTable").datagrid('reload'); // reload the commentOrg data
							}
						}
					});
				},
			...
			var commentOrgInit = {
				...
				dialogOpen : function(data) {
					if (data) {
						...
						commentOrgInit.isTopSelect();
						commentOrgInit.orderText();
